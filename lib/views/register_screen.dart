...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      extendBodyBehindAppBar: true, // Đẩy nền mờ lên sát viền trên cùng
      appBar: AppBar(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('Create Account', style: TextStyle(fontSize: 32, fontWeight: FontWeight.w800, letterSpacing: 0.5)),
                  const SizedBox(height: 8),
                  const Text('Sign up to get started with your fashion store experience.', style: TextStyle(fontSize: 14, color: Colors.black54)),
                  ...
                  Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        _buildMinimalInput(
                          label: 'FULL NAME', hint: 'Enter your full name', icon: Icons.person_outline, controller: nameCtrl,
                          validator: (val) {
                        ...
                        _buildMinimalInput(
                          label: 'PHONE NUMBER', hint: 'e.g., 0901234567', icon: Icons.phone_outlined, controller: phoneCtrl,
                        ...
                        const SizedBox(height: 24),
                        _buildMinimalInput(
                          label: 'EMAIL ADDRESS', hint: 'name@example.com', icon: Icons.email_outlined, controller: emailCtrl,
                        ...
                        const SizedBox(height: 24),
                        _buildMinimalInput(
                          label: 'PASSWORD', hint: 'Minimum 8 characters', icon: Icons.lock_outline, controller: passCtrl, obscure: true,
                          validator: (val) {
                        ...
                        const SizedBox(height: 24),
                        _buildMinimalInput(
                          label: 'CONFIRM PASSWORD', hint: 'Re-enter password', icon: Icons.done_all_outlined, controller: confirmPassCtrl, obscure: true,
                          validator: (val) {
                        ...
                        Row(
                          children: [
                            ...
                            const Expanded(child: Text('I agree with terms and privacy policy.', style: TextStyle(color: Colors.black87, fontSize: 13))),
                          ],
                        ),

                        if (vm.errorMessage != null)
                          Padding(padding: const EdgeInsets.only(top: 16), child: Text(vm.errorMessage!, style: const TextStyle(color: Colors.red, fontSize: 13), textAlign: TextAlign.center)),
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            } : null, // Nếu chưa tick đồng ý thì khóa nút
                            child: vm.isLoading
                                ? const SizedBox(height: 20, width: 20, child: CircularProgressIndicator(color: Colors.white, strokeWidth: 2))
                                : const Text('SIGN UP', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, letterSpacing: 1.5)),
                          ),
                        ),
                      ],
                    ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: const Text('LOG IN', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, letterSpacing: 0.5)),
                      ),
                    ],
                  ),
  ...
  Widget _buildMinimalInput({required String label, required String hint, required IconData icon, required TextEditingController controller, bool obscure = false, TextInputType? keyboardType, String? Function(String?)? validator}) {
    return Column(
