...
class ProfileScreen extends StatelessWidget {
  ...
  // ─────────────────────── DIALOG CHỈNH SỬA THÔNG TIN ───────────────────────
    void _showEditProfileDialog(
      ...
      // Thêm GlobalKey để quản lý Form Validation
          ...
          return AlertDialog(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      ...
                      // Bắt buộc 10 số, bắt đầu bằng số 0
            ...
            actions: [
              ...
              ElevatedButton(
                ...
                onPressed: () async {
                  // Kích hoạt hàm kiểm tra lỗi trước khi lưu
            ...
            _buildMenuCard(
              children: [
                ...
                _buildMenuItem(
                  ...
                  onTap: () {
                    // HIỂN THỊ POPUP CHỮA CHÁY TRUNG TÂM HỖ TRỢ
                    showDialog(
                      context: context,
                      builder: (context) => AlertDialog(
                        ...
                        content: const Column(
                          ...
                          children: [
                            Text('📞 Hotline: 1900 6868'),
                            SizedBox(height: 8),
                            Text('📧 Email: support@brevk.com'),
                            SizedBox(height: 8),
                            Text('🏢 Địa chỉ: Phường 15, Gò Vấp, TP.HCM'),
                            SizedBox(height: 16),
                            Text('Thời gian làm việc: 8h00 - 17h00 (T2-T6)', style: TextStyle(fontSize: 12, color: Colors.grey)),
                          ],
                        ),
                        actions: [
                          TextButton(
                            onPressed: () => Navigator.pop(context),
                            child: const Text('ĐÓNG', style: TextStyle(color: Color(0xFF4361EE), fontWeight: FontWeight.bold)),
                          ),
                        ],
                      ),
                    );
